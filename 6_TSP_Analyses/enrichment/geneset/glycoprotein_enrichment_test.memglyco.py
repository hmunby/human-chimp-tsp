...
GENCODE_BED   = HERE / "resources/gencode.v49.annotation.genes.protein_coding.autosomes." \
                       "gene_names.bed"
GLYCO_TSV = HERE / "../glycoprotein/human_membrane_glycoproteins_KW0325_KW0472_with_coords.tsv"
OUT_TSV = HERE / "membrane_glycoprotein_enrichment_results.tsv"
OUT_MD  = HERE / "membrane_glycoprotein_enrichment_results.md"
...
def main():
    ...
    # ── markdown summary ──────────────────────────────────────────────────────
    md = f"""# Membrane glycoprotein (KW-0325 ∩ KW-0472) enrichment in the test loci
