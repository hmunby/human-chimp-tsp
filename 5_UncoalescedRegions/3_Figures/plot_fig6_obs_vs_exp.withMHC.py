...
chimp_m=chimp_df.copy(); human_m=human_df.copy()   # MHC INCLUDED (supplement variant)
inter_m=inter.copy()
...
print("WITH-MHC quartile enrichment (obs/exp):",{b:round(enr[b],2) for b in labels})
...
for _method,_suffix in [("segment",""),("chromosome",".chromblock")]:
    ...
    build(_ob,_ex,_en,f"{AP}/reciprocal_uncoal_obs_vs_exp.withMHC.quartiles{_suffix}.png")
